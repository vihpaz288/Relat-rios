 ...
 <body>
         ...
         <div class="navbar-menu">
             <ul>
                 ...
                 <li>
                     ...
                     <a href="{{ route('create.relatorio') }}">Novo tópico</a>
                 </li>
                 <li>
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                         class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                 ...
                 <li>
                     ...
                     <a href="{{ route('teste.falta') }}">Relatórios não concludos</a>
                 </li>
                 <li class="sair">
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
     ...
     <div class="content">
         <div class="form">
             <div>
                 <h2>Detalhes do relatorio {{ $detalhes->titulo }}</h2>
             </div>
             <div>
                 <table border="1" class="tabela">
                     ...
                     <tbody>
                         <tr>
                             <td>{{ $detalhes->topico->titulo }}</td>
                             <td>{{ $detalhes->titulo }}</td>
                             <td style="cols="25" rows="4"">{{ $detalhes->descrição }}</td>
                             <td>
                                 @if ($detalhes->situacao == null)
                                     <form action="{{ route('edit', $detalhes->id) }}" method="POST">
                                         @csrf
                                         @method('PUT')
                             ...
                             <td>
                                 @if ($detalhes->situacao == null)
                                     <form action="{{ route('destroy', $detalhes->id) }}" method="POST">
                                         @csrf
                                         @method('DELETE')
